		...
		<div class="span2 pull-right">
			<div class="dropdown pull-right">
				...
				<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
					<? if( $this->user['user_id'] == 2 ){ ?><li><a href="#add_book" data-toggle="modal">Add Book</a></li> <? } ?>
					<? if( $this->user['user_id'] == 2 ){ ?><li><a href="#add_author" data-toggle="modal">Add Author</a></li><? } ?>
